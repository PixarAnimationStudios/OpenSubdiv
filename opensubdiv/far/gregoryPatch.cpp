...
GregoryPatchFactory::GregoryPatchFactory(TopologyRefiner const &refiner) :
    _refiner(refiner) {
}

PatchDescriptor::Type
GregoryPatchFactory::GetPatchType(
PatchTablesFactory::PatchFaceTag const &tag) const {
...
ConstIndexArray
GregoryPatchFactory::GetTopology(Vtr::Level const& level, Index faceIndex,
...
void
GregoryPatchFactory::AddGregoryPatchTables(PatchTables *patchTables)
{
