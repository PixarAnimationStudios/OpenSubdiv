...
public:
    ...
    virtual ~OsdGLSLComputeKernelDispatcher();

    void Refine(FarMesh<OsdVertex> * mesh, OsdGLSLComputeContext *context);

    static OsdGLSLComputeKernelDispatcher * GetInstance();
...
#endif  // OSD_GLSL_COMPUTE_DISPATCHER_H
