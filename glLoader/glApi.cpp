...
#elif __APPLE__
    libGL = dlopen("/System/Library/Frameworks/Versions/Current/OpenGL.framework/OpenGL", RTLD_LAZY | RTLD_LOCAL);
#else
...
static bool hasExt(const char * ext, int n, const char ** exts)
{
    for (int i=0; i<n; ++i) {
...
static bool loadSymbols()
{
    ...
    const char ** exts = 0;
    if (numexts > 0) {
        exts = (const char **)malloc(numexts * sizeof(const char *));
    ...
    GLAPILOADER_GL_AMD_blend_minmax_factor = hasExt("GL_AMD_blend_minmax_factor", numexts, exts);
    GLAPILOADER_GL_AMD_conservative_depth = hasExt("GL_AMD_conservative_depth", numexts, exts);
    GLAPILOADER_GL_AMD_debug_output = hasExt("GL_AMD_debug_output", numexts, exts);
    ...
    GLAPILOADER_GL_AMD_framebuffer_multisample_advanced = hasExt("GL_AMD_framebuffer_multisample_advanced", numexts, exts);
    GLAPILOADER_GL_AMD_framebuffer_sample_positions = hasExt("GL_AMD_framebuffer_sample_positions", numexts, exts);
    GLAPILOADER_GL_AMD_gcn_shader = hasExt("GL_AMD_gcn_shader", numexts, exts);
    GLAPILOADER_GL_AMD_gpu_shader_half_float = hasExt("GL_AMD_gpu_shader_half_float", numexts, exts);
    GLAPILOADER_GL_AMD_gpu_shader_int16 = hasExt("GL_AMD_gpu_shader_int16", numexts, exts);
    GLAPILOADER_GL_AMD_gpu_shader_int64 = hasExt("GL_AMD_gpu_shader_int64", numexts, exts);
    GLAPILOADER_GL_AMD_interleaved_elements = hasExt("GL_AMD_interleaved_elements", numexts, exts);
    GLAPILOADER_GL_AMD_multi_draw_indirect = hasExt("GL_AMD_multi_draw_indirect", numexts, exts);
    GLAPILOADER_GL_AMD_name_gen_delete = hasExt("GL_AMD_name_gen_delete", numexts, exts);
    GLAPILOADER_GL_AMD_occlusion_query_event = hasExt("GL_AMD_occlusion_query_event", numexts, exts);
    GLAPILOADER_GL_AMD_performance_monitor = hasExt("GL_AMD_performance_monitor", numexts, exts);
    GLAPILOADER_GL_AMD_pinned_memory = hasExt("GL_AMD_pinned_memory", numexts, exts);
    GLAPILOADER_GL_AMD_query_buffer_object = hasExt("GL_AMD_query_buffer_object", numexts, exts);
    ...
    GLAPILOADER_GL_AMD_shader_atomic_counter_ops = hasExt("GL_AMD_shader_atomic_counter_ops", numexts, exts);
    GLAPILOADER_GL_AMD_shader_ballot = hasExt("GL_AMD_shader_ballot", numexts, exts);
    GLAPILOADER_GL_AMD_shader_gpu_shader_half_float_fetch = hasExt("GL_AMD_shader_gpu_shader_half_float_fetch", numexts, exts);
    ...
    GLAPILOADER_GL_AMD_shader_explicit_vertex_parameter = hasExt("GL_AMD_shader_explicit_vertex_parameter", numexts, exts);
    GLAPILOADER_GL_AMD_sparse_texture = hasExt("GL_AMD_sparse_texture", numexts, exts);
    GLAPILOADER_GL_AMD_stencil_operation_extended = hasExt("GL_AMD_stencil_operation_extended", numexts, exts);
    ...
    GLAPILOADER_GL_AMD_vertex_shader_layer = hasExt("GL_AMD_vertex_shader_layer", numexts, exts);
    ...
    GLAPILOADER_GL_APPLE_element_array = hasExt("GL_APPLE_element_array", numexts, exts);
    ...
    GLAPILOADER_GL_APPLE_flush_buffer_range = hasExt("GL_APPLE_flush_buffer_range", numexts, exts);
    GLAPILOADER_GL_APPLE_object_purgeable = hasExt("GL_APPLE_object_purgeable", numexts, exts);
    GLAPILOADER_GL_APPLE_rgb_422 = hasExt("GL_APPLE_rgb_422", numexts, exts);
    GLAPILOADER_GL_APPLE_row_bytes = hasExt("GL_APPLE_row_bytes", numexts, exts);
    ...
    GLAPILOADER_GL_APPLE_transform_hint = hasExt("GL_APPLE_transform_hint", numexts, exts);
    GLAPILOADER_GL_APPLE_vertex_array_object = hasExt("GL_APPLE_vertex_array_object", numexts, exts);
    GLAPILOADER_GL_APPLE_vertex_array_range = hasExt("GL_APPLE_vertex_array_range", numexts, exts);
    GLAPILOADER_GL_APPLE_vertex_program_evaluators = hasExt("GL_APPLE_vertex_program_evaluators", numexts, exts);
    GLAPILOADER_GL_APPLE_ycbcr_422 = hasExt("GL_APPLE_ycbcr_422", numexts, exts);
    GLAPILOADER_GL_ARB_ES2_compatibility = hasExt("GL_ARB_ES2_compatibility", numexts, exts);
    GLAPILOADER_GL_ARB_ES3_1_compatibility = hasExt("GL_ARB_ES3_1_compatibility", numexts, exts);
    ...
    GLAPILOADER_GL_ARB_base_instance = hasExt("GL_ARB_base_instance", numexts, exts);
    GLAPILOADER_GL_ARB_bindless_texture = hasExt("GL_ARB_bindless_texture", numexts, exts);
    GLAPILOADER_GL_ARB_blend_func_extended = hasExt("GL_ARB_blend_func_extended", numexts, exts);
    GLAPILOADER_GL_ARB_buffer_storage = hasExt("GL_ARB_buffer_storage", numexts, exts);
    ...
    GLAPILOADER_GL_ARB_clear_texture = hasExt("GL_ARB_clear_texture", numexts, exts);
    ...
    GLAPILOADER_GL_ARB_compressed_texture_pixel_storage = hasExt("GL_ARB_compressed_texture_pixel_storage", numexts, exts);
    GLAPILOADER_GL_ARB_compute_shader = hasExt("GL_ARB_compute_shader", numexts, exts);
    GLAPILOADER_GL_ARB_compute_variable_group_size = hasExt("GL_ARB_compute_variable_group_size", numexts, exts);
    GLAPILOADER_GL_ARB_conditional_render_inverted = hasExt("GL_ARB_conditional_render_inverted", numexts, exts);
    GLAPILOADER_GL_ARB_conservative_depth = hasExt("GL_ARB_conservative_depth", numexts, exts);
    GLAPILOADER_GL_ARB_copy_buffer = hasExt("GL_ARB_copy_buffer", numexts, exts);
    ...
    GLAPILOADER_GL_ARB_debug_output = hasExt("GL_ARB_debug_output", numexts, exts);
    GLAPILOADER_GL_ARB_depth_buffer_float = hasExt("GL_ARB_depth_buffer_float", numexts, exts);
    GLAPILOADER_GL_ARB_depth_clamp = hasExt("GL_ARB_depth_clamp", numexts, exts);
    GLAPILOADER_GL_ARB_depth_texture = hasExt("GL_ARB_depth_texture", numexts, exts);
    GLAPILOADER_GL_ARB_derivative_control = hasExt("GL_ARB_derivative_control", numexts, exts);
    GLAPILOADER_GL_ARB_direct_state_access = hasExt("GL_ARB_direct_state_access", numexts, exts);
    GLAPILOADER_GL_ARB_draw_buffers = hasExt("GL_ARB_draw_buffers", numexts, exts);
    GLAPILOADER_GL_ARB_draw_buffers_blend = hasExt("GL_ARB_draw_buffers_blend", numexts, exts);
    ...
    GLAPILOADER_GL_ARB_draw_instanced = hasExt("GL_ARB_draw_instanced", numexts, exts);
    GLAPILOADER_GL_ARB_enhanced_layouts = hasExt("GL_ARB_enhanced_layouts", numexts, exts);
    GLAPILOADER_GL_ARB_explicit_attrib_location = hasExt("GL_ARB_explicit_attrib_location", numexts, exts);
    GLAPILOADER_GL_ARB_explicit_uniform_location = hasExt("GL_ARB_explicit_uniform_location", numexts, exts);
    ...
    GLAPILOADER_GL_ARB_fragment_program = hasExt("GL_ARB_fragment_program", numexts, exts);
    ...
    GLAPILOADER_GL_ARB_framebuffer_object = hasExt("GL_ARB_framebuffer_object", numexts, exts);
    ...
    GLAPILOADER_GL_ARB_gl_spirv = hasExt("GL_ARB_gl_spirv", numexts, exts);
    ...
    GLAPILOADER_GL_ARB_gpu_shader_int64 = hasExt("GL_ARB_gpu_shader_int64", numexts, exts);
    GLAPILOADER_GL_ARB_half_float_pixel = hasExt("GL_ARB_half_float_pixel", numexts, exts);
    GLAPILOADER_GL_ARB_half_float_vertex = hasExt("GL_ARB_half_float_vertex", numexts, exts);
    ...
    GLAPILOADER_GL_ARB_map_buffer_alignment = hasExt("GL_ARB_map_buffer_alignment", numexts, exts);
    GLAPILOADER_GL_ARB_map_buffer_range = hasExt("GL_ARB_map_buffer_range", numexts, exts);
    GLAPILOADER_GL_ARB_matrix_palette = hasExt("GL_ARB_matrix_palette", numexts, exts);
    GLAPILOADER_GL_ARB_multi_bind = hasExt("GL_ARB_multi_bind", numexts, exts);
    GLAPILOADER_GL_ARB_multi_draw_indirect = hasExt("GL_ARB_multi_draw_indirect", numexts, exts);
    GLAPILOADER_GL_ARB_multisample = hasExt("GL_ARB_multisample", numexts, exts);
    ...
    GLAPILOADER_GL_ARB_occlusion_query2 = hasExt("GL_ARB_occlusion_query2", numexts, exts);
    GLAPILOADER_GL_ARB_parallel_shader_compile = hasExt("GL_ARB_parallel_shader_compile", numexts, exts);
    GLAPILOADER_GL_ARB_pipeline_statistics_query = hasExt("GL_ARB_pipeline_statistics_query", numexts, exts);
    GLAPILOADER_GL_ARB_pixel_buffer_object = hasExt("GL_ARB_pixel_buffer_object", numexts, exts);
    ...
    GLAPILOADER_GL_ARB_polygon_offset_clamp = hasExt("GL_ARB_polygon_offset_clamp", numexts, exts);
    GLAPILOADER_GL_ARB_post_depth_coverage = hasExt("GL_ARB_post_depth_coverage", numexts, exts);
    GLAPILOADER_GL_ARB_program_interface_query = hasExt("GL_ARB_program_interface_query", numexts, exts);
    GLAPILOADER_GL_ARB_provoking_vertex = hasExt("GL_ARB_provoking_vertex", numexts, exts);
    GLAPILOADER_GL_ARB_query_buffer_object = hasExt("GL_ARB_query_buffer_object", numexts, exts);
    ...
    GLAPILOADER_GL_ARB_sampler_objects = hasExt("GL_ARB_sampler_objects", numexts, exts);
    GLAPILOADER_GL_ARB_seamless_cube_map = hasExt("GL_ARB_seamless_cube_map", numexts, exts);
    ...
    GLAPILOADER_GL_ARB_shader_atomic_counters = hasExt("GL_ARB_shader_atomic_counters", numexts, exts);
    GLAPILOADER_GL_ARB_shader_ballot = hasExt("GL_ARB_shader_ballot", numexts, exts);
    GLAPILOADER_GL_ARB_shader_bit_encoding = hasExt("GL_ARB_shader_bit_encoding", numexts, exts);
    GLAPILOADER_GL_ARB_shader_clock = hasExt("GL_ARB_shader_clock", numexts, exts);
    GLAPILOADER_GL_ARB_shader_draw_parameters = hasExt("GL_ARB_shader_draw_parameters", numexts, exts);
    GLAPILOADER_GL_ARB_shader_group_vote = hasExt("GL_ARB_shader_group_vote", numexts, exts);
    GLAPILOADER_GL_ARB_shader_image_load_store = hasExt("GL_ARB_shader_image_load_store", numexts, exts);
    GLAPILOADER_GL_ARB_shader_image_size = hasExt("GL_ARB_shader_image_size", numexts, exts);
    GLAPILOADER_GL_ARB_shader_objects = hasExt("GL_ARB_shader_objects", numexts, exts);
    GLAPILOADER_GL_ARB_shader_precision = hasExt("GL_ARB_shader_precision", numexts, exts);
    GLAPILOADER_GL_ARB_shader_stencil_export = hasExt("GL_ARB_shader_stencil_export", numexts, exts);
    GLAPILOADER_GL_ARB_shader_storage_buffer_object = hasExt("GL_ARB_shader_storage_buffer_object", numexts, exts);
    ...
    GLAPILOADER_GL_ARB_shading_language_100 = hasExt("GL_ARB_shading_language_100", numexts, exts);
    GLAPILOADER_GL_ARB_shading_language_420pack = hasExt("GL_ARB_shading_language_420pack", numexts, exts);
    GLAPILOADER_GL_ARB_shading_language_include = hasExt("GL_ARB_shading_language_include", numexts, exts);
    GLAPILOADER_GL_ARB_shading_language_packing = hasExt("GL_ARB_shading_language_packing", numexts, exts);
    GLAPILOADER_GL_ARB_shadow = hasExt("GL_ARB_shadow", numexts, exts);
    GLAPILOADER_GL_ARB_shadow_ambient = hasExt("GL_ARB_shadow_ambient", numexts, exts);
    GLAPILOADER_GL_ARB_sparse_buffer = hasExt("GL_ARB_sparse_buffer", numexts, exts);
    GLAPILOADER_GL_ARB_sparse_texture = hasExt("GL_ARB_sparse_texture", numexts, exts);
    ...
    GLAPILOADER_GL_ARB_spirv_extensions = hasExt("GL_ARB_spirv_extensions", numexts, exts);
    ...
    GLAPILOADER_GL_ARB_tessellation_shader = hasExt("GL_ARB_tessellation_shader", numexts, exts);
    GLAPILOADER_GL_ARB_texture_barrier = hasExt("GL_ARB_texture_barrier", numexts, exts);
    GLAPILOADER_GL_ARB_texture_border_clamp = hasExt("GL_ARB_texture_border_clamp", numexts, exts);
    GLAPILOADER_GL_ARB_texture_buffer_object = hasExt("GL_ARB_texture_buffer_object", numexts, exts);
    GLAPILOADER_GL_ARB_texture_buffer_object_rgb32 = hasExt("GL_ARB_texture_buffer_object_rgb32", numexts, exts);
    GLAPILOADER_GL_ARB_texture_buffer_range = hasExt("GL_ARB_texture_buffer_range", numexts, exts);
    GLAPILOADER_GL_ARB_texture_compression = hasExt("GL_ARB_texture_compression", numexts, exts);
    GLAPILOADER_GL_ARB_texture_compression_bptc = hasExt("GL_ARB_texture_compression_bptc", numexts, exts);
    GLAPILOADER_GL_ARB_texture_compression_rgtc = hasExt("GL_ARB_texture_compression_rgtc", numexts, exts);
    GLAPILOADER_GL_ARB_texture_cube_map = hasExt("GL_ARB_texture_cube_map", numexts, exts);
    GLAPILOADER_GL_ARB_texture_cube_map_array = hasExt("GL_ARB_texture_cube_map_array", numexts, exts);
    GLAPILOADER_GL_ARB_texture_env_add = hasExt("GL_ARB_texture_env_add", numexts, exts);
    GLAPILOADER_GL_ARB_texture_env_combine = hasExt("GL_ARB_texture_env_combine", numexts, exts);
    GLAPILOADER_GL_ARB_texture_env_crossbar = hasExt("GL_ARB_texture_env_crossbar", numexts, exts);
    GLAPILOADER_GL_ARB_texture_env_dot3 = hasExt("GL_ARB_texture_env_dot3", numexts, exts);
    GLAPILOADER_GL_ARB_texture_filter_anisotropic = hasExt("GL_ARB_texture_filter_anisotropic", numexts, exts);
    GLAPILOADER_GL_ARB_texture_filter_minmax = hasExt("GL_ARB_texture_filter_minmax", numexts, exts);
    GLAPILOADER_GL_ARB_texture_float = hasExt("GL_ARB_texture_float", numexts, exts);
    ...
    GLAPILOADER_GL_ARB_texture_mirrored_repeat = hasExt("GL_ARB_texture_mirrored_repeat", numexts, exts);
    GLAPILOADER_GL_ARB_texture_multisample = hasExt("GL_ARB_texture_multisample", numexts, exts);
    ...
    GLAPILOADER_GL_ARB_texture_rectangle = hasExt("GL_ARB_texture_rectangle", numexts, exts);
    GLAPILOADER_GL_ARB_texture_rg = hasExt("GL_ARB_texture_rg", numexts, exts);
    GLAPILOADER_GL_ARB_texture_rgb10_a2ui = hasExt("GL_ARB_texture_rgb10_a2ui", numexts, exts);
    GLAPILOADER_GL_ARB_texture_stencil8 = hasExt("GL_ARB_texture_stencil8", numexts, exts);
    GLAPILOADER_GL_ARB_texture_storage = hasExt("GL_ARB_texture_storage", numexts, exts);
    GLAPILOADER_GL_ARB_texture_storage_multisample = hasExt("GL_ARB_texture_storage_multisample", numexts, exts);
    GLAPILOADER_GL_ARB_texture_swizzle = hasExt("GL_ARB_texture_swizzle", numexts, exts);
    ...
    GLAPILOADER_GL_ARB_transform_feedback2 = hasExt("GL_ARB_transform_feedback2", numexts, exts);
    GLAPILOADER_GL_ARB_transform_feedback3 = hasExt("GL_ARB_transform_feedback3", numexts, exts);
    GLAPILOADER_GL_ARB_transform_feedback_instanced = hasExt("GL_ARB_transform_feedback_instanced", numexts, exts);
    GLAPILOADER_GL_ARB_transform_feedback_overflow_query = hasExt("GL_ARB_transform_feedback_overflow_query", numexts, exts);
    GLAPILOADER_GL_ARB_transpose_matrix = hasExt("GL_ARB_transpose_matrix", numexts, exts);
    GLAPILOADER_GL_ARB_uniform_buffer_object = hasExt("GL_ARB_uniform_buffer_object", numexts, exts);
    GLAPILOADER_GL_ARB_vertex_array_bgra = hasExt("GL_ARB_vertex_array_bgra", numexts, exts);
    GLAPILOADER_GL_ARB_vertex_array_object = hasExt("GL_ARB_vertex_array_object", numexts, exts);
    GLAPILOADER_GL_ARB_vertex_attrib_64bit = hasExt("GL_ARB_vertex_attrib_64bit", numexts, exts);
    GLAPILOADER_GL_ARB_vertex_attrib_binding = hasExt("GL_ARB_vertex_attrib_binding", numexts, exts);
    GLAPILOADER_GL_ARB_vertex_blend = hasExt("GL_ARB_vertex_blend", numexts, exts);
    ...
    GLAPILOADER_GL_ARB_vertex_shader = hasExt("GL_ARB_vertex_shader", numexts, exts);
    GLAPILOADER_GL_ARB_vertex_type_10f_11f_11f_rev = hasExt("GL_ARB_vertex_type_10f_11f_11f_rev", numexts, exts);
    GLAPILOADER_GL_ARB_vertex_type_2_10_10_10_rev = hasExt("GL_ARB_vertex_type_2_10_10_10_rev", numexts, exts);
    GLAPILOADER_GL_ARB_viewport_array = hasExt("GL_ARB_viewport_array", numexts, exts);
    ...
    GLAPILOADER_GL_EXT_bgra = hasExt("GL_EXT_bgra", numexts, exts);
    GLAPILOADER_GL_EXT_bindable_uniform = hasExt("GL_EXT_bindable_uniform", numexts, exts);
    ...
    GLAPILOADER_GL_EXT_blend_minmax = hasExt("GL_EXT_blend_minmax", numexts, exts);
    GLAPILOADER_GL_EXT_blend_subtract = hasExt("GL_EXT_blend_subtract", numexts, exts);
    GLAPILOADER_GL_EXT_clip_volume_hint = hasExt("GL_EXT_clip_volume_hint", numexts, exts);
    GLAPILOADER_GL_EXT_cmyka = hasExt("GL_EXT_cmyka", numexts, exts);
    GLAPILOADER_GL_EXT_color_subtable = hasExt("GL_EXT_color_subtable", numexts, exts);
    ...
    GLAPILOADER_GL_EXT_copy_texture = hasExt("GL_EXT_copy_texture", numexts, exts);
    GLAPILOADER_GL_EXT_cull_vertex = hasExt("GL_EXT_cull_vertex", numexts, exts);
    GLAPILOADER_GL_EXT_debug_label = hasExt("GL_EXT_debug_label", numexts, exts);
    ...
    GLAPILOADER_GL_EXT_draw_buffers2 = hasExt("GL_EXT_draw_buffers2", numexts, exts);
    GLAPILOADER_GL_EXT_draw_instanced = hasExt("GL_EXT_draw_instanced", numexts, exts);
    GLAPILOADER_GL_EXT_draw_range_elements = hasExt("GL_EXT_draw_range_elements", numexts, exts);
    ...
    GLAPILOADER_GL_EXT_framebuffer_blit = hasExt("GL_EXT_framebuffer_blit", numexts, exts);
    ...
    GLAPILOADER_GL_EXT_framebuffer_object = hasExt("GL_EXT_framebuffer_object", numexts, exts);
    ...
    GLAPILOADER_GL_EXT_gpu_program_parameters = hasExt("GL_EXT_gpu_program_parameters", numexts, exts);
    GLAPILOADER_GL_EXT_gpu_shader4 = hasExt("GL_EXT_gpu_shader4", numexts, exts);
    GLAPILOADER_GL_EXT_histogram = hasExt("GL_EXT_histogram", numexts, exts);
    ...
    GLAPILOADER_GL_EXT_index_texture = hasExt("GL_EXT_index_texture", numexts, exts);
    GLAPILOADER_GL_EXT_light_texture = hasExt("GL_EXT_light_texture", numexts, exts);
    GLAPILOADER_GL_EXT_memory_object = hasExt("GL_EXT_memory_object", numexts, exts);
    GLAPILOADER_GL_EXT_memory_object_fd = hasExt("GL_EXT_memory_object_fd", numexts, exts);
    GLAPILOADER_GL_EXT_memory_object_win32 = hasExt("GL_EXT_memory_object_win32", numexts, exts);
    GLAPILOADER_GL_EXT_misc_attribute = hasExt("GL_EXT_misc_attribute", numexts, exts);
    ...
    GLAPILOADER_GL_EXT_multiview_tessellation_geometry_shader = hasExt("GL_EXT_multiview_tessellation_geometry_shader", numexts, exts);
    GLAPILOADER_GL_EXT_multiview_texture_multisample = hasExt("GL_EXT_multiview_texture_multisample", numexts, exts);
    GLAPILOADER_GL_EXT_multiview_timer_query = hasExt("GL_EXT_multiview_timer_query", numexts, exts);
    GLAPILOADER_GL_EXT_packed_depth_stencil = hasExt("GL_EXT_packed_depth_stencil", numexts, exts);
    GLAPILOADER_GL_EXT_packed_float = hasExt("GL_EXT_packed_float", numexts, exts);
    GLAPILOADER_GL_EXT_packed_pixels = hasExt("GL_EXT_packed_pixels", numexts, exts);
    GLAPILOADER_GL_EXT_paletted_texture = hasExt("GL_EXT_paletted_texture", numexts, exts);
    GLAPILOADER_GL_EXT_pixel_buffer_object = hasExt("GL_EXT_pixel_buffer_object", numexts, exts);
    GLAPILOADER_GL_EXT_pixel_transform = hasExt("GL_EXT_pixel_transform", numexts, exts);
    GLAPILOADER_GL_EXT_pixel_transform_color_table = hasExt("GL_EXT_pixel_transform_color_table", numexts, exts);
    GLAPILOADER_GL_EXT_point_parameters = hasExt("GL_EXT_point_parameters", numexts, exts);
    ...
    GLAPILOADER_GL_EXT_provoking_vertex = hasExt("GL_EXT_provoking_vertex", numexts, exts);
    ...
    GLAPILOADER_GL_EXT_separate_specular_color = hasExt("GL_EXT_separate_specular_color", numexts, exts);
    GLAPILOADER_GL_EXT_shader_framebuffer_fetch = hasExt("GL_EXT_shader_framebuffer_fetch", numexts, exts);
    GLAPILOADER_GL_EXT_shader_framebuffer_fetch_non_coherent = hasExt("GL_EXT_shader_framebuffer_fetch_non_coherent", numexts, exts);
    GLAPILOADER_GL_EXT_shader_image_load_formatted = hasExt("GL_EXT_shader_image_load_formatted", numexts, exts);
    GLAPILOADER_GL_EXT_shader_image_load_store = hasExt("GL_EXT_shader_image_load_store", numexts, exts);
    ...
    GLAPILOADER_GL_EXT_shared_texture_palette = hasExt("GL_EXT_shared_texture_palette", numexts, exts);
    GLAPILOADER_GL_EXT_sparse_texture2 = hasExt("GL_EXT_sparse_texture2", numexts, exts);
    ...
    GLAPILOADER_GL_EXT_stencil_wrap = hasExt("GL_EXT_stencil_wrap", numexts, exts);
    GLAPILOADER_GL_EXT_subtexture = hasExt("GL_EXT_subtexture", numexts, exts);
    GLAPILOADER_GL_EXT_texture = hasExt("GL_EXT_texture", numexts, exts);
    GLAPILOADER_GL_EXT_texture3D = hasExt("GL_EXT_texture3D", numexts, exts);
    GLAPILOADER_GL_EXT_texture_array = hasExt("GL_EXT_texture_array", numexts, exts);
    GLAPILOADER_GL_EXT_texture_buffer_object = hasExt("GL_EXT_texture_buffer_object", numexts, exts);
    ...
    GLAPILOADER_GL_EXT_texture_compression_s3tc = hasExt("GL_EXT_texture_compression_s3tc", numexts, exts);
    GLAPILOADER_GL_EXT_texture_cube_map = hasExt("GL_EXT_texture_cube_map", numexts, exts);
    GLAPILOADER_GL_EXT_texture_env_add = hasExt("GL_EXT_texture_env_add", numexts, exts);
    GLAPILOADER_GL_EXT_texture_env_combine = hasExt("GL_EXT_texture_env_combine", numexts, exts);
    GLAPILOADER_GL_EXT_texture_env_dot3 = hasExt("GL_EXT_texture_env_dot3", numexts, exts);
    GLAPILOADER_GL_EXT_texture_filter_anisotropic = hasExt("GL_EXT_texture_filter_anisotropic", numexts, exts);
    GLAPILOADER_GL_EXT_texture_filter_minmax = hasExt("GL_EXT_texture_filter_minmax", numexts, exts);
    GLAPILOADER_GL_EXT_texture_integer = hasExt("GL_EXT_texture_integer", numexts, exts);
    GLAPILOADER_GL_EXT_texture_lod_bias = hasExt("GL_EXT_texture_lod_bias", numexts, exts);
    GLAPILOADER_GL_EXT_texture_mirror_clamp = hasExt("GL_EXT_texture_mirror_clamp", numexts, exts);
    ...
    GLAPILOADER_GL_EXT_texture_sRGB = hasExt("GL_EXT_texture_sRGB", numexts, exts);
    ...
    GLAPILOADER_GL_EXT_texture_shared_exponent = hasExt("GL_EXT_texture_shared_exponent", numexts, exts);
    GLAPILOADER_GL_EXT_texture_snorm = hasExt("GL_EXT_texture_snorm", numexts, exts);
    GLAPILOADER_GL_EXT_texture_swizzle = hasExt("GL_EXT_texture_swizzle", numexts, exts);
    GLAPILOADER_GL_EXT_timer_query = hasExt("GL_EXT_timer_query", numexts, exts);
    GLAPILOADER_GL_EXT_transform_feedback = hasExt("GL_EXT_transform_feedback", numexts, exts);
    GLAPILOADER_GL_EXT_vertex_array = hasExt("GL_EXT_vertex_array", numexts, exts);
    GLAPILOADER_GL_EXT_vertex_array_bgra = hasExt("GL_EXT_vertex_array_bgra", numexts, exts);
    ...
    GLAPILOADER_GL_EXT_win32_keyed_mutex = hasExt("GL_EXT_win32_keyed_mutex", numexts, exts);
    GLAPILOADER_GL_EXT_window_rectangles = hasExt("GL_EXT_window_rectangles", numexts, exts);
    GLAPILOADER_GL_EXT_x11_sync_object = hasExt("GL_EXT_x11_sync_object", numexts, exts);
    GLAPILOADER_GL_INTEL_conservative_rasterization = hasExt("GL_INTEL_conservative_rasterization", numexts, exts);
    GLAPILOADER_GL_INTEL_fragment_shader_ordering = hasExt("GL_INTEL_fragment_shader_ordering", numexts, exts);
    ...
    GLAPILOADER_GL_INTEL_blackhole_render = hasExt("GL_INTEL_blackhole_render", numexts, exts);
    GLAPILOADER_GL_INTEL_parallel_arrays = hasExt("GL_INTEL_parallel_arrays", numexts, exts);
    GLAPILOADER_GL_INTEL_performance_query = hasExt("GL_INTEL_performance_query", numexts, exts);
    GLAPILOADER_GL_KHR_blend_equation_advanced = hasExt("GL_KHR_blend_equation_advanced", numexts, exts);
    GLAPILOADER_GL_KHR_blend_equation_advanced_coherent = hasExt("GL_KHR_blend_equation_advanced_coherent", numexts, exts);
    GLAPILOADER_GL_KHR_context_flush_control = hasExt("GL_KHR_context_flush_control", numexts, exts);
    GLAPILOADER_GL_KHR_debug = hasExt("GL_KHR_debug", numexts, exts);
    GLAPILOADER_GL_KHR_no_error = hasExt("GL_KHR_no_error", numexts, exts);
    GLAPILOADER_GL_KHR_robust_buffer_access_behavior = hasExt("GL_KHR_robust_buffer_access_behavior", numexts, exts);
    GLAPILOADER_GL_KHR_robustness = hasExt("GL_KHR_robustness", numexts, exts);
    GLAPILOADER_GL_KHR_shader_subgroup = hasExt("GL_KHR_shader_subgroup", numexts, exts);
    GLAPILOADER_GL_KHR_texture_compression_astc_hdr = hasExt("GL_KHR_texture_compression_astc_hdr", numexts, exts);
    ...
    GLAPILOADER_GL_NV_bindless_multi_draw_indirect = hasExt("GL_NV_bindless_multi_draw_indirect", numexts, exts);
    GLAPILOADER_GL_NV_bindless_multi_draw_indirect_count = hasExt("GL_NV_bindless_multi_draw_indirect_count", numexts, exts);
    ...
    GLAPILOADER_GL_NV_blend_equation_advanced_coherent = hasExt("GL_NV_blend_equation_advanced_coherent", numexts, exts);
    GLAPILOADER_GL_NV_blend_minmax_factor = hasExt("GL_NV_blend_minmax_factor", numexts, exts);
    GLAPILOADER_GL_NV_blend_square = hasExt("GL_NV_blend_square", numexts, exts);
    GLAPILOADER_GL_NV_clip_space_w_scaling = hasExt("GL_NV_clip_space_w_scaling", numexts, exts);
    GLAPILOADER_GL_NV_command_list = hasExt("GL_NV_command_list", numexts, exts);
    GLAPILOADER_GL_NV_compute_program5 = hasExt("GL_NV_compute_program5", numexts, exts);
    GLAPILOADER_GL_NV_compute_shader_derivatives = hasExt("GL_NV_compute_shader_derivatives", numexts, exts);
    GLAPILOADER_GL_NV_conditional_render = hasExt("GL_NV_conditional_render", numexts, exts);
    GLAPILOADER_GL_NV_conservative_raster = hasExt("GL_NV_conservative_raster", numexts, exts);
    GLAPILOADER_GL_NV_conservative_raster_dilate = hasExt("GL_NV_conservative_raster_dilate", numexts, exts);
    ...
    GLAPILOADER_GL_NV_copy_depth_to_color = hasExt("GL_NV_copy_depth_to_color", numexts, exts);
    GLAPILOADER_GL_NV_copy_image = hasExt("GL_NV_copy_image", numexts, exts);
    GLAPILOADER_GL_NV_deep_texture3D = hasExt("GL_NV_deep_texture3D", numexts, exts);
    GLAPILOADER_GL_NV_depth_buffer_float = hasExt("GL_NV_depth_buffer_float", numexts, exts);
    ...
    GLAPILOADER_GL_NV_draw_vulkan_image = hasExt("GL_NV_draw_vulkan_image", numexts, exts);
    GLAPILOADER_GL_NV_evaluators = hasExt("GL_NV_evaluators", numexts, exts);
    ...
    GLAPILOADER_GL_NV_fill_rectangle = hasExt("GL_NV_fill_rectangle", numexts, exts);
    GLAPILOADER_GL_NV_float_buffer = hasExt("GL_NV_float_buffer", numexts, exts);
    GLAPILOADER_GL_NV_fog_distance = hasExt("GL_NV_fog_distance", numexts, exts);
    GLAPILOADER_GL_NV_fragment_coverage_to_color = hasExt("GL_NV_fragment_coverage_to_color", numexts, exts);
    ...
    GLAPILOADER_GL_NV_fragment_program4 = hasExt("GL_NV_fragment_program4", numexts, exts);
    GLAPILOADER_GL_NV_fragment_program_option = hasExt("GL_NV_fragment_program_option", numexts, exts);
    GLAPILOADER_GL_NV_fragment_shader_barycentric = hasExt("GL_NV_fragment_shader_barycentric", numexts, exts);
    GLAPILOADER_GL_NV_fragment_shader_interlock = hasExt("GL_NV_fragment_shader_interlock", numexts, exts);
    ...
    GLAPILOADER_GL_NV_geometry_program4 = hasExt("GL_NV_geometry_program4", numexts, exts);
    GLAPILOADER_GL_NV_geometry_shader4 = hasExt("GL_NV_geometry_shader4", numexts, exts);
    GLAPILOADER_GL_NV_geometry_shader_passthrough = hasExt("GL_NV_geometry_shader_passthrough", numexts, exts);
    GLAPILOADER_GL_NV_gpu_program4 = hasExt("GL_NV_gpu_program4", numexts, exts);
    GLAPILOADER_GL_NV_gpu_program5 = hasExt("GL_NV_gpu_program5", numexts, exts);
    GLAPILOADER_GL_NV_gpu_program5_mem_extended = hasExt("GL_NV_gpu_program5_mem_extended", numexts, exts);
    ...
    GLAPILOADER_GL_NV_internalformat_sample_query = hasExt("GL_NV_internalformat_sample_query", numexts, exts);
    GLAPILOADER_GL_NV_light_max_exponent = hasExt("GL_NV_light_max_exponent", numexts, exts);
    GLAPILOADER_GL_NV_gpu_multicast = hasExt("GL_NV_gpu_multicast", numexts, exts);
    ...
    GLAPILOADER_GL_NV_occlusion_query = hasExt("GL_NV_occlusion_query", numexts, exts);
    GLAPILOADER_GL_NV_packed_depth_stencil = hasExt("GL_NV_packed_depth_stencil", numexts, exts);
    GLAPILOADER_GL_NV_parameter_buffer_object = hasExt("GL_NV_parameter_buffer_object", numexts, exts);
    ...
    GLAPILOADER_GL_NV_present_video = hasExt("GL_NV_present_video", numexts, exts);
    GLAPILOADER_GL_NV_primitive_restart = hasExt("GL_NV_primitive_restart", numexts, exts);
    GLAPILOADER_GL_NV_query_resource = hasExt("GL_NV_query_resource", numexts, exts);
    GLAPILOADER_GL_NV_query_resource_tag = hasExt("GL_NV_query_resource_tag", numexts, exts);
    GLAPILOADER_GL_NV_register_combiners = hasExt("GL_NV_register_combiners", numexts, exts);
    ...
    GLAPILOADER_GL_NV_robustness_video_memory_purge = hasExt("GL_NV_robustness_video_memory_purge", numexts, exts);
    GLAPILOADER_GL_NV_sample_locations = hasExt("GL_NV_sample_locations", numexts, exts);
    GLAPILOADER_GL_NV_sample_mask_override_coverage = hasExt("GL_NV_sample_mask_override_coverage", numexts, exts);
    ...
    GLAPILOADER_GL_NV_shader_atomic_float64 = hasExt("GL_NV_shader_atomic_float64", numexts, exts);
    GLAPILOADER_GL_NV_shader_atomic_fp16_vector = hasExt("GL_NV_shader_atomic_fp16_vector", numexts, exts);
    GLAPILOADER_GL_NV_shader_atomic_int64 = hasExt("GL_NV_shader_atomic_int64", numexts, exts);
    GLAPILOADER_GL_NV_shader_buffer_load = hasExt("GL_NV_shader_buffer_load", numexts, exts);
    GLAPILOADER_GL_NV_shader_buffer_store = hasExt("GL_NV_shader_buffer_store", numexts, exts);
    GLAPILOADER_GL_NV_shader_storage_buffer_object = hasExt("GL_NV_shader_storage_buffer_object", numexts, exts);
    ...
    GLAPILOADER_GL_NV_shading_rate_image = hasExt("GL_NV_shading_rate_image", numexts, exts);
    ...
    GLAPILOADER_GL_NV_texture_barrier = hasExt("GL_NV_texture_barrier", numexts, exts);
    GLAPILOADER_GL_NV_texture_compression_vtc = hasExt("GL_NV_texture_compression_vtc", numexts, exts);
    GLAPILOADER_GL_NV_texture_env_combine4 = hasExt("GL_NV_texture_env_combine4", numexts, exts);
    GLAPILOADER_GL_NV_texture_expand_normal = hasExt("GL_NV_texture_expand_normal", numexts, exts);
    GLAPILOADER_GL_NV_texture_multisample = hasExt("GL_NV_texture_multisample", numexts, exts);
    GLAPILOADER_GL_NV_texture_rectangle = hasExt("GL_NV_texture_rectangle", numexts, exts);
    GLAPILOADER_GL_NV_texture_rectangle_compressed = hasExt("GL_NV_texture_rectangle_compressed", numexts, exts);
    ...
    GLAPILOADER_GL_NV_texture_shader3 = hasExt("GL_NV_texture_shader3", numexts, exts);
    GLAPILOADER_GL_NV_transform_feedback = hasExt("GL_NV_transform_feedback", numexts, exts);
    GLAPILOADER_GL_NV_transform_feedback2 = hasExt("GL_NV_transform_feedback2", numexts, exts);
    GLAPILOADER_GL_NV_uniform_buffer_unified_memory = hasExt("GL_NV_uniform_buffer_unified_memory", numexts, exts);
    GLAPILOADER_GL_NV_vdpau_interop = hasExt("GL_NV_vdpau_interop", numexts, exts);
    GLAPILOADER_GL_NV_vdpau_interop2 = hasExt("GL_NV_vdpau_interop2", numexts, exts);
    GLAPILOADER_GL_NV_vertex_array_range = hasExt("GL_NV_vertex_array_range", numexts, exts);
    GLAPILOADER_GL_NV_vertex_array_range2 = hasExt("GL_NV_vertex_array_range2", numexts, exts);
    GLAPILOADER_GL_NV_vertex_attrib_integer_64bit = hasExt("GL_NV_vertex_attrib_integer_64bit", numexts, exts);
    ...
    GLAPILOADER_GL_NV_vertex_program4 = hasExt("GL_NV_vertex_program4", numexts, exts);
    GLAPILOADER_GL_NV_video_capture = hasExt("GL_NV_video_capture", numexts, exts);
    GLAPILOADER_GL_NV_viewport_array2 = hasExt("GL_NV_viewport_array2", numexts, exts);
    GLAPILOADER_GL_NV_viewport_swizzle = hasExt("GL_NV_viewport_swizzle", numexts, exts);
    GLAPILOADER_GL_EXT_texture_shadow_lod = hasExt("GL_EXT_texture_shadow_lod", numexts, exts);
