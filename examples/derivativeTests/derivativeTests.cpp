...
// Usage notes:
//
// 1) The executable dumps the most important info to cout and more verbose details to cerr.
//
// 2) To compare results using floats vs doubles, switch the "typedef double FD" line
//      to "typedef float FD" near the top of this file.
//
// 3) Of course, the derivative testing will not produce accurate results in Gregory patches
//      unless we turn on the new OPENSUBDIV_GREGORY_EVAL_TRUE_DERIVATIVES option.
//
