...
createOsdMesh(ShapeDesc const & shapeDesc, int level) {
    ...
    int nverts=0;
    {
        ...
        Far::GregoryBasisFactory *gregoryBasisFactory = new
            Far::GregoryBasisFactory(*g_topologyRefiner);

        Far::PatchTables const * patchTables =
            Far::PatchTablesFactory::Create(*g_topologyRefiner, poptions, gregoryBasisFactory);
